                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <p> <code>Number of objectives: m</code></p>
                                <p> <code>Number of knapsacks: k</code></p>
                                <p> <code>Number of items: n</code></p>
                                <p>
                                    Data file input must comply with the following format:
                                </p>
                                <p>
                                    First <code>m</code> lines include criterion coefficient matrix $C^{mxn}$ with entries $c_{ij}$.
                                    For criterion $i$, entries of matrix row $i$, $C_i=[c_{i1}, c_{i2},...c_{in}]$, should be <code>single-space</code> delimited
                                    and last entry should be followed by <code>new line("\n")</code> character. Next <code>k</code> lines specify the weight
                                    coefficient matrix, $W^{kxn}$. Row $k$ of matrix $W$, $W_k=[w_{k1},w_{k2},...w_{kn}]$, specifies the weight of items in knapsack $k$. 
                                    Each row entry should be <code>single-space</code> delimited and last entry should be followed by <code>new line("\n")</code>
                                    character. Knapsack capacities are represented by column vector of size <code>k</code> and each entry should be specified
