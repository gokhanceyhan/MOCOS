            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="libMOCO-S.jsp">Library</a></li>
                        <li class="dropdown">
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>    
                                            ...
                                            <td> <a href=../../libraryFiles/Knapsack/<%= resultset.getString(2)%>/<%= resultset.getString(3)%>/<%= resultset.getString(4)%>/<%= resultset.getString(6)%> download target="_blank" role="button"><span class="glyphicon glyphicon-save-file"></span></a></td>                                  
                                            <td> <a href=../../libraryFiles/Knapsack/<%= resultset.getString(2)%>/<%= resultset.getString(3)%>/<%= resultset.getString(4)%>/<%= resultset.getString(7)%> download target="_blank" role="button"><span class="glyphicon glyphicon-save-file"></span></a></td>                             
                                        </tr>
                                        <% }%>
                                    </tbody>
                                </table>
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>    
                                            ...
                                            <td> <%= resultset.getString(3)%></td>
                                            <td> <%= resultset.getString(4)%></td>
                                            <td> <a href=../../libraryFiles/Assignment/<%= resultset.getString(2)%>/<%= resultset.getString(3)%>/<%= resultset.getString(5)%> download target="_blank" role="button"><span class="glyphicon glyphicon-save-file"></span></a></td>                                  
                                            <td> <a href=../../libraryFiles/Assignment/<%= resultset.getString(2)%>/<%= resultset.getString(3)%>/<%= resultset.getString(6)%> download target="_blank" role="button"><span class="glyphicon glyphicon-save-file"></span></a></td>                             
                                        </tr>
                                        <% }%>
                                    </tbody>
                                </table>
